    ...
    >
      <Container>
        ...
        <p className="mt-4 max-w-xl text-lg tracking-tight text-slate-600">
          Lingua Clarity offers a one-time fee package that allows you to learn a new language at your own pace.
        </p>
      </Container>
      <div className="mx-auto mt-16 max-w-5xl lg:px-6">
        <div className="grid bg-slate-50 sm:px-6 sm:pb-16 md:grid-cols-1 md:rounded-6xl md:px-8 md:pt-16 lg:p-20">
          ...
          <Plan
            featured
            name="Complete"
            description="Learn to speak the language you desire in no time while accomodating your schedule."
            price="100"
            href="#"
            features={[
              ...
              'Weekly quizzes shaped to your needs',
              '24/7 Availability',
              'Instant feedback',
