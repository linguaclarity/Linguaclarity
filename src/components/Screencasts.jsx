...
const videos = [
  {
    title: 'Start with text-based conversations',
    description:
  ...
  },
  {
    ...
    description:
      'Instant feedback that will help you improve your language skills in a short period.',
    image: gridsImage,
    runtime: { minutes: 9, seconds: 12 },
  },
  {
    title: 'Work on your speaking skills',
    description:
      'Using the interactive sessions, you can work on your speaking skills and pronunciation.',
    image: strokesImage,
    runtime: { minutes: 23, seconds: 25 },
  },
  {
    title: 'Quizzes and assessments shaped to your level of training',
    description:
    ...
    >
      <Container>
        ...
        <p className="mt-8 font-display text-4xl font-bold tracking-tight text-slate-900">
          Become fluent in the language you desire on your free time.
        </p>
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          Learn to speak the language you desire on your own schedule by using our provided resources. Our AI language chatbot is designed to help you learn the language you desire quickly and efficiently.
        </p>
      </Container>
