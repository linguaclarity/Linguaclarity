        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              We developed and designed Lingua Clarity to help you achieve fluency in a new language that you desire in a fun, accessible, and effective way. We believe that learning a new language should be an enjoyable experience, and we are committed to making that a reality for you. 
              We believe that learning a new language can be challenging due to the lack of resources and the high cost of language sessions with human experts. Therefore, with Lingua Clarity, you have all the resources to fulfill your goal.
            </p>
            <p className="mt-8">
              <Link
                href="#"
